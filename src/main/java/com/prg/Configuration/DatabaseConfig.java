...
import com.prg.dbboot.Entities.*;
...
public class DatabaseConfig extends AbstractCloudConfig {
    ...
    @Value("${vcap.services.prg_pgrce.credentials.username}")
    private String username;

    @Value("${vcap.services.prg_pgrce.credentials.password}")
    private String password;

    @Value("${vcap.services.prg_pgrce.credentials.hostname}")
    private String hostname;

    @Value("${vcap.services.prg_pgrce.credentials.port}")
    private String port;

    @Value("${vcap.services.prg_pgrce.credentials.dbname}")
